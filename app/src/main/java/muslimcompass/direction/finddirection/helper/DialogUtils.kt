...
import muslimcompass.direction.finddirection.databinding.CustomProgressBinding
import muslimcompass.direction.finddirection.databinding.LyLanguagesBinding
import muslimcompass.direction.finddirection.databinding.LySettingsBinding
import muslimcompass.direction.finddirection.lang.LanguagesAdapter
...
//        binding.lyDetailSet.background = context.resources.getDrawable(R.drawable.dialog_bg)
    ...
    fun showLanguagesDialog() {
        ...
        lp.copyFrom(dialog.window!!.attributes)
        lp.width = (context.resources.displayMetrics.widthPixels * 0.90).toInt()
        lp.height = (context.resources.displayMetrics.heightPixels * 0.60).toInt()
//        lp.height = WindowManager.LayoutParams.WRAP_CONTENT
        dialog.window!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
        dialog.window!!.attributes = lp
        binding.lyDetailLang.background = context.resources.getDrawable(R.drawable.dialog_bg)
