package qiblacompass.qibladirection.finddirection.lang
...
import qiblacompass.qibladirection.finddirection.databinding.LanguageCustomCellBinding
...
class LanguagesAdapter(
    ...
    val locales = arrayOf("en", "ar", "es", "fr", "tr", "ru")
    ...
    inner class RecyclerViewViewHolder(
        ...
        fun bind(pos: Int) {
            ...
            if (position == GeneralUtils.languagesFlag) {
                ...
                tv_language.setTextColor(context.resources.getColor(R.color.black))
            }
        }
